...
class Shapes3D(datasets.shapes3d, ground_truth_data.GroundTruthData):
  ...
  """
	...
	def __init__(self, data_file = os.path.join(os.environ['FOUNDATION_DATA_DIR'],'shapes3d'), latent_factor_indices=None):
		...
		super().__init__(dataroot = data_file, train = False)
